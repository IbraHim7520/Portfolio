...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased p-5 bg-dark`}>
      ...
      <div className="w-full min-h-screen flex flex-col md:grid  md:grid-cols-12 gap-5">
        ...
        <div className="w-full min-h-screen col-span-9 bg-secondary shadow rounded-lg">
